...
public class SetColorPriceTable extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        if (1 == (int) table.getValueAt(row, 8) && column == 1) {
            setBackground(Color.BLUE);
            setForeground(Color.WHITE);
        } else if (2 == (int) table.getValueAt(row, 8) && column == 1) {
            setBackground(Color.YELLOW);
            setForeground(Color.BLACK);
        } else if (3 == (int) table.getValueAt(row, 8) && column == 1) {
            setBackground(Color.ORANGE);
            setForeground(Color.BLACK);
        } else if (4 == (int) table.getValueAt(row, 8) && column == 1) {
            setBackground(Color.GREEN);
            setForeground(Color.BLACK);
        }
